...
| [`docs/BROWSER-AGENT-BRIEF.md`](docs/BROWSER-AGENT-BRIEF.md) | Paste-ready brief for an agent driving the Wix Studio UI — all six editor fixes, with verification and a report template |
