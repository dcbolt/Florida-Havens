...
export const metadata: Metadata = {
  title: 'Refund Policy',
  description: 'Cancellation and refund terms for direct bookings with The Florida Havens.',
  ...
  return (
    <section className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      ...
      <div className="mt-8 rounded-sm border border-dashed border-ocean-300 bg-ocean-50 p-5 text-sm text-ocean-700">
        ...
        <code className="rounded bg-white/70 px-1">/refund-policy</code> verbatim. This
