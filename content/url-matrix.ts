...
export const URL_MATRIX: UrlRow[] = [
  ...
  { from: '/dunes-emergency-guide', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 0, words: null },
  ...
  { from: '/dunes-waste-management', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 0, words: null },
