...
/**
 * Where guest-ops URLs point.
 *
 * REDLINE (Grok, 2026-07-26, verified independently): `welcome.mediahaven.app`
 * has no DNS record at all — neither it nor `mediahaven.app` resolves. Shipping
 * 42 permanent redirects to a nonexistent host would be worse than leaving the
 * pages up: Google would see a broken redirect target on every one.
 *
 * So until Devin confirms the production guest-portal host, these resolve to an
 * on-domain `/guest-portal` notice page, which is `noindex` (so the index bloat
 * is still cleared) and links out to the portal. Flip
 * `GUEST_PORTAL.hostConfirmed` to true in content/site.ts and the same rows
 * become external 301s with no other change.
 */
export const GUEST_PORTAL_TARGET = GUEST_PORTAL.hostConfirmed
  ? GUEST_PORTAL.url
  : GUEST_PORTAL.fallbackPath
...
export const URL_MATRIX: UrlRow[] = [
  ...
  { from: '/beach-street-ac', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 950, words: 195 },
  { from: '/beach-street-amenities', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 973, words: 370 },
  { from: '/beach-street-bbq-grill-guide', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 951, words: 192 },
  { from: '/beach-street-beach-rules', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 957, words: 344 },
  { from: '/beach-street-check-in', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 947, words: 191 },
  { from: '/beach-street-check-out', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 967, words: 402 },
  { from: '/beach-street-emergency-guide', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 968, words: 646 },
  { from: '/beach-street-guidebook', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 1073, words: 442 },
  ...
  { from: '/beach-street-shuttle-launches', to: '/guides/space-coast-rocket-launches', action: '301', note: 'demand content, not guest-ops — live title is "Space Coast Rocket Launch Schedule"; folded into the rocket guide', liveKb: 949, words: 167 },
  { from: '/beach-street-tv-entertainment-guide', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 951, words: 197 },
  { from: '/beach-street-waste-management', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 946, words: 254 },
  { from: '/beach-strret-wifi-guide', to: GUEST_PORTAL_TARGET, action: '301', note: 'TYPO SLUG — redirect then retire', liveKb: 947, words: 133 },
  ...
  { from: '/connect-dunes', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 980, words: 113 },
  { from: '/connect-havens', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 980, words: 112 },
  { from: '/contact', to: '/contact', action: 'KEEP', note: '1:1 URL, no redirect needed', liveKb: 994, words: 158 },
  { from: '/dunes-air-conditioning', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 950, words: 218 },
  { from: '/dunes-amenities', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 971, words: 361 },
  { from: '/dunes-bbq-grill-guide', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 951, words: 202 },
  { from: '/dunes-beach-guide', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 959, words: 413 },
  { from: '/dunes-check-in', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 947, words: 191 },
  { from: '/dunes-check-out', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 967, words: 392 },
  { from: '/dunes-emergency-guide', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 968, words: 634 },
  { from: '/dunes-ev-charging', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 949, words: 228 },
  { from: '/dunes-guide-book', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 1076, words: 457 },
  ...
  { from: '/dunes-tv-entertainment-guide', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 953, words: 209 },
  { from: '/dunes-waste-management', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 946, words: 271 },
  { from: '/dunes-wifi-guide', to: GUEST_PORTAL_TARGET, action: '301', note: 'guest-ops → Media Haven (never on marketing domain)', liveKb: 946, words: 118 },
  ...
  { from: '/guest-resources', to: GUEST_PORTAL_TARGET, action: '301', note: 'hub → Media Haven portal', liveKb: 1268, words: 128 },
  ...
  { from: '/stay-near-space-coast-rocket-launches-kennedy-space-center-beach-house', to: '/guides/space-coast-rocket-launches', action: '301', note: 'SEO demand page → /guides/*', liveKb: 1027, words: 580 },
